...
| [0024](0024-requirement-title-field.md) | `Requirement.title` schema gap-fill & inclusion in generic-CRUD `search_fields` (no new mechanism, reuses ADR-0022's `?q=`) | Accepted |

**Deciders on all ADRs below:** xuanbinh91@gmail.com (CTO), unless noted otherwise.
**Date:** 2026-09-03 (0001–0017, 0021), 2026-09-04 (0018–0020), 2026-09-05 (0022–0024)
