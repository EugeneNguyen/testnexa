...
| [0028](0028-testcase-resolver-direct-link-fallback.md) | `TestCase` org-resolver direct-link fallback (REQ-2 gap-fill): `RequirementTestCaseLink` added as a 3rd branch, checked before the `TestSuiteTestCase` fallback — a direct-link `TestCase` had no resolver path and 404'd as "orphaned" right after creation | Accepted |

**Deciders on all ADRs below:** xuanbinh91@gmail.com (CTO), unless noted otherwise.
**Date:** 2026-09-03 (0001–0017, 0021), 2026-09-04 (0018–0020), 2026-09-05 (0022–0028)
