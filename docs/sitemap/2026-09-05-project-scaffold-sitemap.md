...
**SHELL-10 (2026-09-09, [ADR-0050](../adr/0050-shell-10-project-scope-entity-nav.md)):** the same 5 route patterns now render a distinct project-mode sidebar (4 entity groups over `projectScopedEntities` + 2 "back" links), not the org nav SHELL-9 rendered there — no route/component change to any of these screens, purely `AppSidebar`'s own content.
