...
| FR-ADMIN-2, NFR-36 | [ADR-0025](../adr/0025-generic-admin-crud-ui-and-backend-completion.md) Generic admin CRUD UI + execution/traceability backend completion, 28-page final scope (every ERD entity except `Approval`/`User`/`AIAgent`/`AuthIdentity`) |
