...
| 4.2 | ~~TestPlan/EntryExitCriteria/TestCycle/Environment routes~~, execution-scope-check (execution only against TestCase in a suite included in the plan) | 3.2 | M | FR-PLAN-3 |
