...
## 15. RBAC-3 RoleAssignment creation & project-scoped enforcement — equivalence classes ([ADR-0021](../adr/0021-role-assignment-creation-flow.md))
