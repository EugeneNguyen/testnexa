...
| Method | Path | Permission | Maps to |
|---|---|---|---|
| POST | `/requirements/{id}/test-cases` | `test_case.create` | FR-REQ-2 — direct link path, creates TestCase + RequirementTestCaseLink atomically — **not yet built** |
| POST | `/requirements/{id}/test-conditions` | `test_condition.create` | FR-REQ-3 — creates TestCondition + RequirementTestConditionLink — built, [ADR-0028](../adr/0028-req3-test-condition-rigor-path-bespoke-routes.md) |
| POST | `/test-conditions/{id}/test-cases` | `test_case.create` | FR-REQ-3 — creates TestCase + TestConditionTestCaseLink — built, [ADR-0028](../adr/0028-req3-test-condition-rigor-path-bespoke-routes.md) |
