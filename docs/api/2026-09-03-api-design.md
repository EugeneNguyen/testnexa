...
```
The third, and last, meaning `409` carries in this API, alongside RESTRICT-blocked-delete and signup-closed — each scoped to its own route family, never conflated.
