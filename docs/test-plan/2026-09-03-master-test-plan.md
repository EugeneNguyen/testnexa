...
- Frontend SPA (React/Vite) — generic CRUD surface + bespoke workflow screens + the persistent admin shell (sidebar + navbar) wrapping every `ProtectedRoute` screen
