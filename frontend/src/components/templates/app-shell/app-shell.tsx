 ...
 *
 * SHELL-7 (ADR-0044) added `sidebar-mini`. It is a *constant* modifier, not a
 ...
 * "always expand".
 *
 * **SHELL-7 (ADR-0044) note — deliberate, documented divergence.** That inline
 ...
 * this keeps the pre-SHELL-7 behavior of expanding. ADR-0044 scopes SHELL-7 to
