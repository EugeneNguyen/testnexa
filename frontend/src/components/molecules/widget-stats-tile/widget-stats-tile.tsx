 ...
 *
 * Tier placement: `frontend/src/components/molecules/` (ADR-0043,
 * 2026-09-08, superseding ADR-0023's `components/shared/` location and this
 * comment's own prior claim that the repo doesn't use atoms/molecules/
 * organisms tiers — it now does, repo-wide). A molecule: one icon+label+
 * value composite, same tier as `FeaturedCard`/`FormField`.
 *
