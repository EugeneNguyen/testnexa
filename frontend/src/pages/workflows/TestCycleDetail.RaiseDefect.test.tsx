...
import { listTestExecutionLogs } from "../../lib/api/testLogs";
import { createDefectForExecution } from "../../lib/api/defects";
...
// ADR-0053: see `TestCycleDetail.test.tsx`'s own note — `FkAutocomplete` now
// fetches its ref-entity config via `useEntitySchema`, so this tree needs a
// `QueryClientProvider` it previously did not.
