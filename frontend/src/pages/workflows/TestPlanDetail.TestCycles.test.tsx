...
// ADR-0053: `TestPlanDetail` now sources its own and `EntryExitCriteria`'s
// field shape from `useEntitySchema` (a `useQuery`), and its `FkAutocomplete`s
// resolve ref-entity configs the same way — so this tree needs a
