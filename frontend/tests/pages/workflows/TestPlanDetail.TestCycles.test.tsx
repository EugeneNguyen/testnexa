...
import { createTestCycle } from "../../../src/lib/api/testCycles";
import type { TestCycleSummary } from "../../../src/lib/api/testCycles";
import { createEntity, getEntity, listEntities } from "../../../src/lib/api/entityCrud";
import type { EntityRow, ListEnvelope } from "../../../src/lib/api/entityCrud";
...
vi.mock("../../../src/lib/api/testCycles", async (importOriginal) => {
  const actual = await importOriginal<typeof import("../../../src/lib/api/testCycles")>();
