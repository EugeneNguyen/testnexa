...
import { createTestExecution } from "../../../src/lib/api/testExecutions";
import type {
  TestExecutionResultValue,
  TestExecutionSummary,
} from "../../../src/lib/api/testExecutions";
...
vi.mock("../../../src/lib/api/testExecutions", async (importOriginal) => {
  const actual = await importOriginal<typeof import("../../../src/lib/api/testExecutions")>();
...
async function resolvedRequestUrl(
  ...
  const actual = await vi.importActual<typeof import("../../../src/lib/api/entityCrud")>(
